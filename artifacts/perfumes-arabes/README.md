...
- Catálogo de 23 perfumes com filtro por gênero
...
Abra o arquivo `src/pages/Home.tsx` e localize o array `collections` no início do arquivo (por volta da linha 13).
...
| O que mudar | Arquivo |
|---|---|
| Produtos do catálogo | `src/pages/Home.tsx` |
