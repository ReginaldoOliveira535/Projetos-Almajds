...
const collections = [
  {
    id: "oud-al-majd",
    name: "Oud Al Majd",
    description: "A joia da coroa. Notas profundas de oud cambojano, incenso ancestral e especiarias reais.",
    price: "R$ 459",
    priceNum: 459,
  ...
  },
  {
    id: "sultan-al-layl",
    name: "Sultan Al Layl",
    description: "O soberano da noite. Tabaco negro envelhecido, couro escuro e vetiver defumado.",
    price: "R$ 429",
    priceNum: 429,
    image: "/images/sultan-al-layl.png",
    gender: "masculino" as Gender,
    notes: "Tabaco · Couro · Vetiver"
  },
  {
    id: "khashab",
    name: "Khashab",
    description: "A essência das florestas sagradas. Cedro do Atlas, oud branco e sândalo cremoso.",
    price: "R$ 349",
    priceNum: 349,
    image: "/images/khashab.png",
    gender: "masculino" as Gender,
    notes: "Cedro · Oud Branco · Sândalo"
  },
  {
    id: "al-asad",
    name: "Al Asad",
    description: "A força do leão. Pimenta negra afiada, bergamota siciliana e âmbar escuro.",
    price: "R$ 379",
    priceNum: 379,
    image: "/images/al-asad.png",
    gender: "masculino" as Gender,
    notes: "Pimenta · Bergamota · Âmbar"
  },
  {
    id: "night-orion",
    name: "Night of Orion",
    description: "Mistério estelar. Cardamomo, madeiras nobres e a rara íris negra.",
    price: "R$ 299",
    priceNum: 299,
    image: "/images/night-orion.png",
    gender: "masculino" as Gender,
    notes: "Cardamomo · Madeiras · Íris"
  },
  {
    id: "desert-musk",
    name: "Desert Musk",
    description: "O silêncio do deserto. Almíscar branco, couro escuro e um leve toque de jasmim noturno.",
    price: "R$ 259",
    priceNum: 259,
    image: "/images/desert-musk.png",
    gender: "masculino" as Gender,
    notes: "Almíscar · Couro · Jasmim"
  },
  {
    id: "amber-royale",
    name: "Amber Royale",
    description: "Calor líquido. Âmbar dourado, baunilha de Madagascar e toques de sândalo precioso.",
    price: "R$ 389",
    priceNum: 389,
    image: "/images/amber-royale.png",
    gender: "feminino" as Gender,
    notes: "Âmbar · Baunilha · Sândalo"
  },
  {
    id: "rose-baghdad",
    name: "Rose of Baghdad",
    description: "A rainha das flores. Rosa damascena, patchouli escuro e açafrão precioso.",
    price: "R$ 329",
    priceNum: 329,
    image: "/images/rose-baghdad.png",
    gender: "feminino" as Gender,
    notes: "Rosa · Patchouli · Açafrão"
  },
  {
    id: "nour",
    name: "Nour",
    description: "A pureza da luz. Flor de laranjeira em plena floração, almíscar branco e ylang-ylang.",
    price: "R$ 289",
    priceNum: 289,
    image: "/images/nour.png",
    gender: "feminino" as Gender,
    notes: "Laranjeira · Almíscar · Ylang"
  },
  {
    id: "laylat-al-qadr",
    name: "Laylat Al Qadr",
    description: "A noite do destino. Jasmim samambaie, osmanthus delicado e âmbar rosado.",
    price: "R$ 359",
    priceNum: 359,
    image: "/images/laylat-al-qadr.png",
    gender: "feminino" as Gender,
    notes: "Jasmim · Osmanthus · Âmbar Rosa"
  },
  {
    id: "yasmin-al-sham",
    name: "Yasmin Al Sham",
    description: "O jasmim de Damasco. Pétalas frescas de jasmim, sândalo branco e almíscar de cetim.",
    price: "R$ 319",
    priceNum: 319,
    image: "/images/yasmin-al-sham.png",
    gender: "feminino" as Gender,
    notes: "Jasmim · Sândalo · Almíscar"
  },
  {
    id: "qamr",
    name: "Qamr",
    description: "O brilho da lua cheia. Almíscar lunar, íris persa e um véu delicado de baunilha.",
    price: "R$ 299",
    priceNum: 299,
    image: "/images/nour.png",
    gender: "feminino" as Gender,
    notes: "Almíscar · Íris · Baunilha"
  },
  {
    id: "al-ward",
    name: "Al Ward",
    description: "O jardim eterno. Rosa turca absoluta, framboesa negra e musgo branco cremoso.",
    price: "R$ 339",
    priceNum: 339,
    image: "/images/rose-baghdad.png",
    gender: "feminino" as Gender,
    notes: "Rosa · Framboesa · Musgo"
  },
  {
    id: "kahrab",
    name: "Kahrab",
    description: "Âmbar vivo e pulsante. Resina de âmbar báltico, patchouli dourado e fava tonka.",
    price: "R$ 369",
    priceNum: 369,
    image: "/images/amber-royale.png",
    gender: "feminino" as Gender,
    notes: "Âmbar · Patchouli · Tonka"
  },
  {
    id: "sihr",
    name: "Sihr",
    description: "Feitiço oriental. Incenso azul, violeta selvagem e almíscar de cetim sobre sândalo.",
    price: "R$ 349",
    priceNum: 349,
    image: "/images/laylat-al-qadr.png",
    gender: "feminino" as Gender,
    notes: "Incenso · Violeta · Almíscar"
  },
  {
    id: "bahr",
    name: "Bahr",
    description: "A imensidão do oceano árabe. Aquático salino, cedro branco e âmbar cinza.",
    price: "R$ 279",
    priceNum: 279,
    image: "/images/yasmin-al-sham.png",
    gender: "feminino" as Gender,
    notes: "Aquático · Cedro · Âmbar Cinza"
  },
  {
    id: "fakher",
    name: "Fakher Al Oud",
    description: "O orgulho do oud. Oud indiano raro, cravo negro e benjoim envelhecido.",
    price: "R$ 499",
    priceNum: 499,
    image: "/images/oud-al-majd.png",
    gender: "masculino" as Gender,
    notes: "Oud Indiano · Cravo · Benjoim"
  },
  {
    id: "ramih",
    name: "Ramih",
    description: "A flecha do caçador. Pimenta vermelha, gengibre fresco e couro árabe com base de âmbar.",
    price: "R$ 349",
    priceNum: 349,
    image: "/images/al-asad.png",
    gender: "masculino" as Gender,
    notes: "Pimenta · Gengibre · Couro"
  },
  {
    id: "majd-al-nar",
    name: "Majd Al Nar",
    description: "Glória de fogo. Notas defumadas de mogno queimado, vetiver úmido e resina de olíbano.",
    price: "R$ 419",
    priceNum: 419,
    image: "/images/sultan-al-layl.png",
    gender: "masculino" as Gender,
    notes: "Mogno · Vetiver · Olíbano"
  },
  {
    id: "malek",
    name: "Malek",
    description: "O rei absoluto. Bergamota italiana, coração de íris e âmbar negro sobre cedro fumado.",
    price: "R$ 389",
    priceNum: 389,
    image: "/images/khashab.png",
    gender: "masculino" as Gender,
    notes: "Bergamota · Íris · Âmbar Negro"
  },
  {
    id: "rih-al-sahra",
    name: "Rih Al Sahra",
    description: "O vento do deserto. Sândalo branco, almíscar nu e especiarias do Marrocos.",
    price: "R$ 269",
    priceNum: 269,
    image: "/images/desert-musk.png",
    gender: "masculino" as Gender,
    notes: "Sândalo · Almíscar · Especiarias"
  },
  {
    id: "zafran",
    name: "Zafran Imperial",
    description: "O ouro líquido do Irã. Açafrão puro, rosa negra e um fundo profundo de oud e madeiras.",
    price: "R$ 439",
    priceNum: 439,
    image: "/images/night-orion.png",
    gender: "masculino" as Gender,
    notes: "Açafrão · Rosa Negra · Oud"
  }
];

const filterLabels: { key: Gender; label: string }[] = [
...
export default function Home() {
  const [activeFilter, setActiveFilter] = useState<Gender>("todos");
        ...
        <div className="container mx-auto px-6 text-center mb-16">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto mb-12">
              Onze fragrâncias exclusivas, elaboradas sem pressa para quem entende que o verdadeiro luxo é intemporal.
            </p>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            {!cadastroSubmitted ? (
              ...
              >
                <div className="w-20 h-20 border border-primary/40 flex items-center justify-center mx-auto">
          ...
          <div className="max-w-2xl mx-auto bg-card border border-border p-12 md:p-16">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="space-y-2">
                ...
                <Input data-testid="input-name" className="bg-background border-border focus-visible:ring-primary h-12 rounded-none" />
              </div>
              <div className="space-y-2">
                <label className="text-sm tracking-wider uppercase text-muted-foreground">Email</label>
                <Input data-testid="input-email" type="email" className="bg-background border-border focus-visible:ring-primary h-12 rounded-none" />
              </div>
              <div className="space-y-2">
                <label className="text-sm tracking-wider uppercase text-muted-foreground">Fragrância Desejada</label>
                <select data-testid="select-fragrance" className="flex h-12 w-full border border-border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary rounded-none text-foreground">
                  <option value="" disabled>Selecione uma fragrância...</option>
              ...
              <div className="space-y-2">
                ...
                <Textarea data-testid="input-message" className="bg-background border-border focus-visible:ring-primary min-h-[120px] rounded-none" />
              </div>
              <Button data-testid="button-submit" className="w-full bg-primary text-primary-foreground hover:bg-primary/90 h-14 font-serif tracking-widest uppercase rounded-none mt-4">
                Enviar Solicitação
              </Button>
            </form>
          </div>
